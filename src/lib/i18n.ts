...
export const translations = {
  ...
  en: {
    ...
    // Shop Orders
    createWorkOrder: 'Create Shop Order',
    workOrderNumber: 'Shop Order Number',
    ...
    // Shop Orders Page
    manageWorkOrders: 'Manage production shop orders',
    createWorkOrderDesc: 'Create a new production shop order',
    failedLoadWorkOrders: 'Failed to load shop orders',
    workOrderCreated: 'created successfully',
    workOrderExists: 'already exists. Please use a different number.',
    noWorkOrdersYet: 'No shop orders yet',
    createFirstWorkOrder: 'Create your first shop order to get started',
    created: 'Created',
    cancelWorkOrder: 'Cancel Shop Order',
    confirmCancelWorkOrder: 'Are you sure you want to cancel this shop order? This will hide it from the list but keep the history for traceability.',
    cancelWorkOrderConfirm: 'This will hide it from the list but keep the history for traceability.',
    cancelWorkOrderConfirmText: 'Are you sure you want to cancel shop order',
    cancellationReason: 'Reason for Cancellation',
    enterCancellationReason: 'Please explain why this shop order is being cancelled...',
    cancellationReasonRequired: 'A reason is required to cancel a shop order',
    keepWorkOrder: 'Keep Shop Order',
    confirmCancel: 'Cancel Shop Order',
    cancelling: 'Cancelling...',
    workOrderCancelled: 'Shop order cancelled',
    deleteButton: 'Delete',
    customer: 'Customer',
    ...
    workOrderNotFound: 'Shop order not found',
    backToWorkOrders: 'Back to Shop Orders',
    items: 'Items',
    step: 'Step',
    of: 'of',
    ...
    workInstructionsDescription: 'Create and manage step-by-step work instructions for operators',
    addInstruction: 'Add Instruction',
    createWorkInstruction: 'Create Work Instruction',
    editWorkInstruction: 'Edit Work Instruction',
    instructionTitle: 'Instruction Title',
    instructionDescription: 'Instruction Description',
    linkToProductionStep: 'Link to Production Step',
    noSpecificStep: 'No specific step (general instruction)',
    instructionCreated: 'Work instruction created',
    instructionUpdated: 'Work instruction updated',
    instructionDeleted: 'Work instruction deleted',
    noInstructionsYet: 'No work instructions yet',
    createFirstInstruction: 'Create your first work instruction',
    instructionSteps: 'Instruction Steps',
    addInstructionStep: 'Add Step',
    editInstructionStep: 'Edit Instruction Step',
    ...
    stepAdded: 'Instruction step added',
    stepUpdated: 'Instruction step updated',
    stepDeleted: 'Instruction step deleted',
    needHelp: 'Need Help?',
    viewInstructions: 'View detailed instructions for this step',
    noInstructionsAvailable: 'No instructions available',
    noInstructionsConfigured: 'No work instructions have been configured for this step yet.',
    recommended: 'Recommended',
    markAsUnderstood: 'Mark as understood',
  ...
  nl: {
    ...
    workOrderNumber: 'Werkordernummer',
    ...
    workInstructionsDescription: 'Maak en beheer stapsgewijze werkinstructies voor operators',
    addInstruction: 'Instructie Toevoegen',
    createWorkInstruction: 'Werkinstructie Aanmaken',
    editWorkInstruction: 'Werkinstructie Bewerken',
    instructionTitle: 'Instructie Titel',
    instructionDescription: 'Instructie Beschrijving',
    linkToProductionStep: 'Koppelen aan Productiestap',
    noSpecificStep: 'Geen specifieke stap (algemene instructie)',
    instructionCreated: 'Werkinstructie aangemaakt',
    instructionUpdated: 'Werkinstructie bijgewerkt',
    instructionDeleted: 'Werkinstructie verwijderd',
    noInstructionsYet: 'Nog geen werkinstructies',
    createFirstInstruction: 'Maak je eerste werkinstructie aan',
    instructionSteps: 'Instructiestappen',
    addInstructionStep: 'Stap Toevoegen',
    editInstructionStep: 'Instructiestap Bewerken',
    stepNumber: 'Stapnummer',
    stepTitle: 'Stap Titel',
    stepContent: 'Instructies',
    warningText: 'Waarschuwing',
    tipText: 'Tip',
    estimatedDuration: 'Geschatte Duur',
    requiredTools: 'Benodigd Gereedschap',
    stepAdded: 'Instructiestap toegevoegd',
    stepUpdated: 'Instructiestap bijgewerkt',
    stepDeleted: 'Instructiestap verwijderd',
    needHelp: 'Hulp Nodig?',
    viewInstructions: 'Bekijk gedetailleerde instructies voor deze stap',
    noInstructionsAvailable: 'Geen instructies beschikbaar',
    noInstructionsConfigured: 'Er zijn nog geen werkinstructies voor deze stap geconfigureerd.',
    recommended: 'Aanbevolen',
    markAsUnderstood: 'Markeer als begrepen',
    understood: 'Begrepen!',
    previous: 'Vorige',
    next: 'Volgende',
    instructionsCompleted: 'voltooid',
    minutes: 'minuten',
  },
};
