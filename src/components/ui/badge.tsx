...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2 py-0.5 text-[10px] font-semibold font-data uppercase tracking-wide pointer-events-none select-none whitespace-nowrap",
  {
    variants: {
      variant: {
