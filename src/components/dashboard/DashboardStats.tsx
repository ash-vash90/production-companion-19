    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card className="border-l-4 border-l-primary">
        ...
        <CardContent>
          ...
          <p className="mt-1 text-xs text-muted-foreground">of {stats.totalWorkOrders} total</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-4 border-l-accent">
        ...
        <CardContent>
          ...
          <p className="mt-1 text-xs text-muted-foreground">items active</p>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-4 border-l-secondary">
        ...
        <CardContent>
          ...
          <p className="mt-1 text-xs text-muted-foreground">ready for shipment</p>
        </CardContent>
      </Card>

      <Card className="border-l-4 border-l-muted">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Step Executions</CardTitle>
          <TrendingUp className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-3xl font-bold font-mono">{stats.totalSteps}</div>
          <p className="mt-1 text-xs text-muted-foreground">quality checkpoints</p>
        </CardContent>
      </Card>
    </div>
  );
